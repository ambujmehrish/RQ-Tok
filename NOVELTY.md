# Bifrost-Flow vs. Bifrost-1 — What's New and Why

This document states precisely how **Bifrost-Flow** differs from its baseline
...
Bifrost-Flow **keeps Bifrost-1's central, validated insight** — bridge a *frozen MLLM*
...
>
> **Bifrost-Flow:** the MLLM predicts an **adaptive-depth residual-quantized** code
...
| # | Bifrost-1 weakness | Bifrost-Flow mechanism | Where it lives |
|---|---|---|---|
...
Bifrost-1 has **no tokenizer**: a patch *is* its raw CLIP vector. Bifrost-Flow inserts a
...
Bifrost-1's branch has a single linear *vision head* trained with **MSE**. Bifrost-Flow's
...
| Prior work | What it has | What Bifrost-Flow adds over it |
|---|---|---|
...
baseline** under matched compute) are generated by `bifrost_flow/eval/ablations.py`
